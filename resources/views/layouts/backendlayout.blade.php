    ...
    <body class="main">
        ...
        <div class="d-flex">
            ...
            <nav class="side-nav">
                ...
                <ul>
                  @include('layouts.partials.sideber')                 
                </ul>
            </nav>
            <!-- END: Side Menu -->
            <!-- BEGIN: Content -->
            <div class="content">
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb me-auto d-none d-sm-flex"> <a href="index.html">Application</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="index.html" class="breadcrumb--active">{{ breadcrumb()}}</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                    ...
                    <div class="intro-x dropdown w-8 h-8">
                        ...
                        <div class="dropdown-menu w-56">
                            <ul class="dropdown-content bg-theme-26 dark-bg-dark-6 text-white">
                                ...
                                <li>
                                    <a href="{{ route('logout')}}" 
                                    onclick="event.preventDefault(); document.getElementById('layout-form').submit();                                    
